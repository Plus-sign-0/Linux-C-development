...
//填充
    ...
    //状态矩阵变成十六进制字符串
    public static String Matrix_To_Hexstr(String[][] matrix){
        String str="";
        for(int i=0;i<4;i++){
            for(int j=0;j<4;j++){
                str+=matrix[j][i];
...
// 逆字节代换运算
    ...
    // 逆S盒
        public  static final int[][] INV_S = new int[][]{
    ...
    public static final int[][] A=new int[][]{
        ...
        public  static final int[][] inverse_A = new int[][]{
        {0x0e, 0x0b, 0x0d, 0x09},
        {0x09, 0x0e, 0x0b, 0x0d},
        {0x0d, 0x09, 0x0e, 0x0b},
        {0x0b, 0x0d, 0x09, 0x0e}
...
//Rcon数据表
        public  static final String[][] Rcon =new String[][]{
    ...
    public static String[][] key_expansion(String str){
        String[][] arr=new String[4][4];
        String[][] expansion_matrix=new String[4][44];
        int i,j,k;
        arr=GetMatrix(str);
        for(i=0;i<4;i++){
            for(j=0;j<4;j++){
                expansion_matrix[i][j]=arr[i][j];
            }
        }
        int line=4;
        for(i=1;i<11;i++){
            ...
            for(j=0;j<4;j++){
                for(k=0;k<4;k++){
                    expansion_matrix[j][line+k]=arr[j][k];
                }
            }
            line+=4;
        }
